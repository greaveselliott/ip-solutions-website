            ...
            <div class="<?php echo !empty($related_resources) ? 'col-sm-8' : 'col-sm-12' ?> ?>">
                    ...
                    <div class="col-sm-4 col-sm-offset-4">
                        <figure class="table-center-container">
                            <div class="table-center-cell">
                                <h3 class="h4 text-white template-solution-heading-cloud"><?php the_field('subheading_inside_cloud'); ?></h3>
                ...
                if( have_rows('the_solution') ):
                        ...
                        while ( have_rows('the_solution') ) : the_row();
                            ?>
                            <div class="row border-1-green margin-bottom-large position-relative text-blue">

                                <div class="col-sm-12">
                                    <img src="<?php the_sub_field('image'); ?>" alt="An Icon relating to this this solution"  class="corner-image">
                                    <div class="circle-bottom-green"></div>


                                    <div class="padding"><?php the_sub_field('solution_content');?></div>
                                </div>
                            </div>
                        <?php
                        endwhile;
