            ...
            <div class="force-aspect-ratio-tablet-up height-100-tablet-portrait ">
                ...
                <div class="table-center-container">
                    <div class="table-center-cell">
                        ...
                        <a href="<?php echo get_permalink($post->ID); ?>" target="_blank" title="Click here to download the file attachment" class="btn btn-orange"><i class="fa fa-download"></i>&nbsp;View File</a><?php
                        else :?>
