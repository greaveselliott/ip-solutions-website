...
<div class="social-sidebar display-none-important-tablet-portrait">
    <ul>
        ...
        <li class="linkedin"><a href="https://www.linkedin.com/company/ip-solutions-uk-ltd" target="_blank" title="Connect with IP Solutions on Linked-in" class="text-white"><i class="fa fa-facebook"></i></a></li>
