    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">What category?</label>
                        <div class="col-sm-9">
                            <?php eemjii_related_taxonomy_filter('category'); ?>
                        </div>
                    </div>
                </form>
            </div>
            <div class="col-sm-6">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">What Service?</label>
                        <div class="col-sm-9">
                            <?php
...
<div class="row">
    <div class="mix-it-up">
        ...
        <div class="width-100 mix <?php echo $this_taxonomy_obj->slug?>" data-myorder="<?php echo $i; ?>">
            <?php echo '<h2 class="display-block">' .$this_taxonomy_obj->name . '</h2>';?>
