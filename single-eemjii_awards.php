...
<div class="width-100 position-relative min-height-200px">
    <div class="header-offset"></div>
    <div class="table-center-container min-height-200px">

        <div class="table-center-cell">
            <?php echo eemjii_get_featured_image_url( get_the_ID(), 'wide-1000-3-1'); ?>
        </div>
    </div>
    <!-- background image -->
    <div class="height-100 width-100 position-absolute top-0 left-0" style="background-image: url('<?php echo get_stylesheet_directory_uri() .'/images/awards_background.jpg';?>'); background-size: cover; z-index: -10;"></div>
</div>
