<?php
    ...
    $client_class      .= get_field('toggled_testimonial', $post->ID) ? 'has_testimonial' : 'no-testimonial';
?>
<div class="col-sm-2 <?php echo $client_class; ?>">
    <img src="<?php echo get_field('client_logo', $post->ID);?>">
    <?php if($has_case_study) : ?>
        <a href="<?php echo $related_case_study[0]->guid ?>" class="btn btn-orange">Read Case Study</a>
    <?php endif; ?>
</div>
<!--<pre>-->
<!--    --><?php //print_r($related_case_study); ?>
<!--</pre>-->