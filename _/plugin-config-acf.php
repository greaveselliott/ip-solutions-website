...
function my_acf_settings_path( $path ) {
    ...
    // update path
    $path = get_stylesheet_directory() . '/_/advanced-custom-fields-pro/';
...
function my_acf_settings_dir( $dir ) {
    ...
    // update path
    $dir = get_stylesheet_directory_uri() . '/_/advanced-custom-fields-pro/';
...
// 4. Include ACF
include_once( get_stylesheet_directory() . '/_/advanced-custom-fields-pro/acf.php' );