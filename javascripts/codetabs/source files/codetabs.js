        ...
        FX = {
            ...
            */
            css : function() {
                ...
                var prefix     = 'code',        // Prefix chung cho file '_code.animate.scss'
                    idCur      = cs.idCur,
                    idLast     = cs.idLast,
    ...
    csPLUGIN.SLIDESHOW = {
        ...
        play : function() {
            ...
            var that  = this,
                ...
                nextPlayFn = function() {
                    that.M.tc(ti.play);
                    ti.play = setTimeout(that.reset, va.speed[cs.idCur] + 10);
                };
        ...
        reset : function() {
            ...
            // console.log('reset', va.tDelay, is.hoverAction);
            this.play();
        },
        ...
        pause : function(_isStop) {
            ...
            is.timer && isTIMER && TIMER.stop();    // Timer: stop
            that.M.tc(that.ti.play);                // PlayAuto: clears
        },
