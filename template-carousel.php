...
// display a sub field value
    ...
    <?php
        ...
        while ( have_rows('slickjs_carousel') ) : the_row();
            ?>
        <div style="background-image: url(' <?php echo wp_get_attachment_image_src(get_sub_field('slide_background_image'), 'xlarge')[0];?>'); z-index: -10; background-size: cover; background-position: center;"></div>
    <?php
    endwhile;
endif; ?>
        </div>
